		...
		<div class="col-lg-6">
			...
			<form action="edit.php?ID=<?php echo $ma ?>"  method="POST" class="shadow p-3">
				<div class="form-group">
					...
					<div class="">	
						<input type="text" class="form-control" name="txtten" value="<?php echo $name ?>" placeholder="Ten"  >
					</div>
				</div>
				<div class="form-group">
					<label class="control-label" >SĐT</label>
					<div class="">
						<input type="text" class="form-control" name="txtsdt" value="<?php echo $phone ?>" placeholder="Số điện thoại">
					</div>
				</div>
				<div class="form-group">
