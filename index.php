...
<body>
	<div class="container pt-3">
		<h3 class="text-center text-monospace pb-2">Danh bạ điện thoại</h3>
		<div class="form-group has-search">
      <span class="fa fa-search form-control-feedback"></span>
      <input class="form-control" id="myInput" type="text" placeholder="Search..">
    </div>

		<a class="text-white btn btn-primary" href="insert.php"><i class="fas fa-plus-circle"></i> Create</a>
		<a class="text-white btn btn-primary" href="logout.php"><i class="fas fa-plus-circle"></i> Logout</a>
		...
		<div class="shadow">
			<table class="table table-bordered mt-4">
				...
				<tbody>
					<?php 
						include_once 'conn.php';
						$q = " SELECT * FROM qldanhba LIMIT $start, $limit";
					...
					<tr>
						...
						<td>
							<div class="d-flex justify-content-center">
								<a class="text-white btn btn-danger mr-2" href="update.php?ma=<?php echo $row['ma']; ?>"><i class="fas fa-edit"></i> Edit</a>
